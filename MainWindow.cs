...
namespace GenshinImpact_WishOnStreamGUI
{
    public partial class MainWindow : Form
    {
        ...
        string updateurl = "https://raw.githubusercontent.com/honganqi/GenshinWishOnStreamGUI/main/latest.json";
        string downloadURL = "";
        ...
        static void ResponseThread()
        {
            ...
            while (true)
            {
                ...
                {
                    //authVar.GetUserInfo(access_token);
                    //Console.WriteLine("Code is not null: https://sidestreamnetwork.net/GenshinTwitchRedeems/?code=" + code + "&fromgui");
                    //htmlContent = new WebClient().DownloadString("https://sidestreamnetwork.net/GenshinTwitchRedeems/?code=" + code + "&fromgui");
        ...
        public void InitializeCharactersPanel(StarList starList)
        {
            ...
            foreach (KeyValuePair<int, CharacterListInStar> charListPair in starList.Reverse())
            {
                ...
                headerLabel.Text = starValue.ToString() + "-Star";
                ...
                rateBox.Text = charListPair.Value.PullRate.ToString();
                ...
                foreach (Character character in charList)
                {
                    ...
                    txtbox.Text = character.CharacterName;
